...
On paper or using a tool such as [excalidraw.com](excalidraw.com), create a program flow map for the sequence of if-statements you need to evaluate for fizzbuzz. Add the picture to the folder containing this file, and name the picture flowchart.png.
...
Can you modify the code above so that the result is stored in a value `y`?
...
In R, you can use the function [`stopifnot()` to halt function execution if there is an error](https://www.rdocumentation.org/packages/base/versions/3.6.2/topics/stopifnot). 
...
See more examples of this in the [Input Validation](https://srvanderplas.github.io/unl-stat850/control-structures.html#input-validation) section of the textbook.
